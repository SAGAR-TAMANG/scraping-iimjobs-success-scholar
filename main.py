  ...
  for pages in pages:
    ...
    for job_elem1 in job_elems1:
      ...
      if finding == 1:
        ...
        dff.to_excel("IIMJobsJobListing_BANKING_FINANCE"+ str(datetime.date.today()) + ".xlsx", index = False)
        print(dff)
      else:
        pass
...
def sales_marketing():
  ...
  for pages in pages:
    ...
    for job_elem1 in job_elems1:
      ...
      if finding == 1:
        dff = pd.concat([dff, pd.DataFrame([[Title, Exp, City, Date, Site, URL, ]], columns = ['Job Title', 'Experience Reqd', 'City', 'Date Posted', 'Site', 'URL'])], ignore_index=True)
        dff.to_excel("IIMJobsJobListing_SALES_MARKETING_"+ str(datetime.date.today()) + ".xlsx", index = False)
        print(dff)
      else:
        pass
  driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/div[9]/div[5]/div/div/div[3]/div/a').click()
...
def consulting():
  ...
  for pages in pages:
    ...
    for job_elem1 in job_elems1:
      ...
      if finding == 1:
        dff = pd.concat([dff, pd.DataFrame([[Title, Exp, City, Date, Site, URL, ]], columns = ['Job Title', 'Experience Reqd', 'City', 'Date Posted', 'Site', 'URL'])], ignore_index=True)
        dff.to_excel("IIMJobsJobListing_consulting_"+ str(datetime.date.today()) + ".xlsx", index = False)
        print(dff)
      else:
        pass
  driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/div[9]/div[5]/div/div/div[3]/div/a').click()
...
def hr_it():
  ...
  for pages in pages:
    ...
    for job_elem1 in job_elems1:
      ...
      if finding == 1:
        dff = pd.concat([dff, pd.DataFrame([[Title, Exp, City, Date, Site, URL, ]], columns = ['Job Title', 'Experience Reqd', 'City', 'Date Posted', 'Site', 'URL'])], ignore_index=True)
        dff.to_excel("IIMJobsJobListing_hr_it_"+ str(datetime.date.today()) + ".xlsx", index = False)
        print(dff)
      else:
        pass
  driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/div[9]/div[5]/div/div/div[3]/div/a').click()
...
def it_systems():
  ...
  for pages in pages:
    ...
    for job_elem1 in job_elems1:
      ...
      if finding == 1:
        dff = pd.concat([dff, pd.DataFrame([[Title, Exp, City, Date, Site, URL, ]], columns = ['Job Title', 'Experience Reqd', 'City', 'Date Posted', 'Site', 'URL'])], ignore_index=True)
        dff.to_excel("IIMJobsJobListing_it_systems_"+ str(datetime.date.today()) + ".xlsx", index = False)
        print(dff)
      else:
        pass
  driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/div[9]/div[5]/div/div/div[3]/div/a').click()
...
def scm_operations():
  ...
  for pages in pages:
    ...
    for job_elem1 in job_elems1:
      ...
      if finding == 1:
        dff = pd.concat([dff, pd.DataFrame([[Title, Exp, City, Date, Site, URL, ]], columns = ['Job Title', 'Experience Reqd', 'City', 'Date Posted', 'Site', 'URL'])], ignore_index=True)
        dff.to_excel("IIMJobsJobListing_scm_operations_"+ str(datetime.date.today()) + ".xlsx", index = False)
        print(dff)
      else:
        pass
  driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/div[9]/div[5]/div/div/div[3]/div/a').click()
...
def legal():
  ...
  for pages in pages:
    ...
    for job_elem1 in job_elems1:
      ...
      if finding == 1:
        dff = pd.concat([dff, pd.DataFrame([[Title, Exp, City, Date, Site, URL, ]], columns = ['Job Title', 'Experience Reqd', 'City', 'Date Posted', 'Site', 'URL'])], ignore_index=True)
        dff.to_excel("IIMJobsJobListing_legal_"+ str(datetime.date.today()) + ".xlsx", index = False)
        print(dff)
      else:
        pass
  driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/div[9]/div[5]/div/div/div[3]/div/a').click()
...
def bpo():
  ...
  for pages in pages:
    ...
    for job_elem1 in job_elems1:
      ...
      if finding == 1:
        dff = pd.concat([dff, pd.DataFrame([[Title, Exp, City, Date, Site, URL, ]], columns = ['Job Title', 'Experience Reqd', 'City', 'Date Posted', 'Site', 'URL'])], ignore_index=True)
        dff.to_excel("IIMJobsJobListing_bpo_"+ str(datetime.date.today()) + ".xlsx", index = False)
        print(dff)
      else:
        pass
  driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/div[9]/div[5]/div/div/div[3]/div/a').click()
